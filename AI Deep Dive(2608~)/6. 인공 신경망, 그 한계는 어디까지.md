...
#### MLP 구조에 따른 특징 및 표현력 비교
 <p align="center"> 
 <img src="./images/6/2.png" alt="코드의 case" width="80%">
 </p> 
* **Case 1 (은닉층 1개, 노드 3개)**
...
### 3. Beautiful insights for ANN(AI가 스스로 학습을 한다는 것의 실체)  
  ...
  - MLP는 행렬 곱하고 벡터 더하고 activation의 반복  
  - 핵심: 인공 신경망은 함수  
  - 어떤함수? -> 어떤 연속 함수든 표현 가능한 함수   
  - 원하는 출력이 나오도록(Loss를 줄임) 조금씩 가중치를 업데이트(Gradient의 반대로 나아가는 것)해 나가는것 -> 그것이 AI가 학습을 한다는 것의 실체   
