...
```
https://colab.research.google.com/drive/1LpnWCtj0eBup-N_zo9-NWxbj7gZXlL7J#scrollTo=SzwdIjWaVjx3&fullscreenOutput=true
...
https://colab.research.google.com/drive/1LpnWCtj0eBup-N_zo9-NWxbj7gZXlL7J#scrollTo=xTOIxpzYQ5ds&fullscreenOutput=true

  

 - Relu10 Layer의 실험 영상  
 · Layer를 10개만 사용한 결과 Vanishing Gradient, Loss landscape 없이 잘 동작됨  
  ![ReLU10 비교](./videos/7/BNReLU10C1.gif)  


- Relu100 Layer의 실험 영상  
 · Layer를 100개 사용한 결과 영상 가장 처음 왼쪽에서 오른쪽으로 감소하는 막대는 Vanishing Gradient 반대임.(Vanishing Gradient는 gradient가 오른쪽에서 크고 왼쪽에서 작아지는 → 마지막층에서는 gradient가 크고 앞쪽측에서 작아짐) 따라서 healthy norm 인 상황임.  
 · 이런 상황에서 under fitting이 발생한 것은 Loss landscape가 발생했다고 볼 수 있음.  
   ![ReLU100 비교](./videos/7/BNReLU100C1.gif)  
