...
예를 들어 값들이 $$-5,-4,-3.4,-3.1,-2$$ 처럼 한쪽 영역에 치우쳐 있다면, BN을 통해 값의 분포가 대략 $$\text{음수} \quad 0 \quad \text{양수}$$ 를 중심으로 재배치될 가능성이 높아진다.  
...
예를 들어 $$x_1=10,\quad x_2=20,\quad x_3=30,\quad x_4=40,\quad x_5=50$$ 이라면 $$\mu_B=\frac{10+20+30+40+50}{5}=30$$ 이다.  
