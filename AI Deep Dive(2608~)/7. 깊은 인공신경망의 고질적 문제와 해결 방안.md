...
```
 ...
 · Activation을 Relu로 사용한 결과 BN의 적용이 결과에 영향을 거의 미치지 않음.
  → Relu는 BN을 적용하지 않아도 Gradient Vanishing이 이미 해결이 되어 BN 적용 전/후 결과가 비슷함.
  <p align="center"> 
<video src="./videos/7/comparison_ReLU_10C1.mp4" controls width="100%"></video>  
 </p>  
...
- Sigmoid의 실험 영상  
 · Activation을 Sigmoid로 사용한 결과 BN의 적용이 결과에 영향을 많이 줌.
  → BN 미적용 시 accuracy는 11.3% 의 결과를 보여줬지만, accuracyBN 적용 시 94.4%의 결과를 보여줌  
    <p align="center"> 
<video src="./videos/7/comparison_Sigmoid_10C1.mp4" controls width="100%"></video>
 </p>  